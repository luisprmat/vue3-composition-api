<template>
    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 mb-4 rounded relative" role="alert" v-if="errors && errors.length">
        ...
        </span> TODO: Activate close button-->
    </div>
